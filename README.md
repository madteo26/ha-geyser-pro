...
![Version](https://img.shields.io/badge/version-0.8.12-green.svg)
...
### Next treatment matching

The dashboard matches the next treatment by **time and scheduled weekday**, not by time alone. This avoids selecting a weekday cycle when a weekend cycle has the same hour.
